...
public class RedisConfig {
	...
	ReactiveRedisTemplate<String, PhotoDto> reactiveRedisTemplate(ReactiveRedisConnectionFactory connectionFactory) {
		...
		RedisSerializationContext.RedisSerializationContextBuilder<String, PhotoDto> builder = RedisSerializationContext
		...
		Jackson2JsonRedisSerializer<PhotoDto> serializer = new Jackson2JsonRedisSerializer<>(objectMapper,
				PhotoDto.class);
	...
	ReactiveRedisTemplate<String, String> reactiveRedisTemplateTemp(ReactiveRedisConnectionFactory connectionFactory) {
		...
		RedisSerializationContext<String, String> serializationContext = RedisSerializationContext
				.<String, String>newSerializationContext(stringSerializer).key(stringSerializer) // Serializza le chiavi
																									// come stringhe
				.value(stringSerializer) // Serializza i valori come stringhe
				.hashKey(stringSerializer).hashValue(stringSerializer).build();
