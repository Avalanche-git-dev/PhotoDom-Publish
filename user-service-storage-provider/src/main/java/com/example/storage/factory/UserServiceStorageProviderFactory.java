package com.example.storage.factory;
...
import com.example.storage.client.UserServiceClientHttp;
import com.example.storage.provider.UserServiceStorageProvider;
 ...
 public class UserServiceStorageProviderFactory implements UserStorageProviderFactory<UserServiceStorageProvider> {
     ...
     public static final String BASE_URL = "baseUrl"; // Nome della proprietà di configurazione
	...
	public static final String AUTH_PASSWORD = "AuthPassword";
     ...
     public List<ProviderConfigProperty> getConfigProperties() {
         return ProviderConfigurationBuilder.create()
                 .property(BASE_URL, "Base URL", "The base URL of the external user service API", ProviderConfigProperty.STRING_TYPE, "", null)
                 .property(AUTH_USERNAME, "Base Username", "Username for BasicAuth at the API", ProviderConfigProperty.STRING_TYPE, "", null)
     			 .property(AUTH_PASSWORD, "Base Password", "Password for BasicAuth at the API", ProviderConfigProperty.PASSWORD, "", null)
                 .build();
     }
