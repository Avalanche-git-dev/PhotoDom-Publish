...
-- Rende di nuovo 'id' una colonna IDENTITY AUTO_INCREMENT
ALTER TABLE "photo_service_db"."photo_metadata"
    ALTER COLUMN id ADD GENERATED BY DEFAULT AS IDENTITY;
-- 👇 
SELECT setval(pg_get_serial_sequence('"photo_service_db"."photo_metadata"', 'id'), (SELECT MAX(id) FROM "photo_service_db"."photo_metadata"));
SELECT setval(pg_get_serial_sequence('"photo_service_db"."likes"', 'id'), (SELECT MAX(id) FROM "photo_service_db"."likes"));




ALTER TABLE "photo_service_db"."likes"
    ALTER COLUMN id ADD GENERATED BY DEFAULT AS IDENTITY;
